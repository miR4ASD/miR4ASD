...
class GeneticPage(StudiesTablePage):
    ...
    def __init__(self, page: Page, base_url: str):
        ...
        super().__init__(
            ...
            show_selected_btn="#gen-show-selected-btn",
        )
    ...
    def is_filters_collapsed(self) -> bool:
        """Return True when the genetic filter inputs are collapsed/hidden."""
        return self.is_filter_card_collapsed(self.FILTER_MATURE)

    def toggle_filters(self) -> None:
        """Expand or collapse the genetic filter inputs card."""
        self.toggle_filter_card("genetic")
